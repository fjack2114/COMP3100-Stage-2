...
public class XML{
    ...
    public static ArrayList<StaticServerList> parse(String xmlConfigurationPath) throws FileNotFoundException {

        ArrayList<StaticServerList> serverList = null;
        try {
            ...
            for (int temp = 0; temp < nodes.getLength(); temp++) {
                ...
                StaticServerList s = new StaticServerList(type, limit, bootupTime, hourlyRate, coreCount, memory, disk);
                serverList.add(s);
            }
